...
layer1 = tflearn.fully_connected(input_layer, 20, activation='sigmoid')
layer2 = tflearn.fully_connected(layer1, 20, activation='sigmoid')
output_layer  = tflearn.fully_connected(layer2, 2, activation='sigmoid')
...
model.fit(train_features, train_labels_onehot, n_epoch=100,
          validation_set=0.2,#(test_features, test_labels_onehot),
          show_metric=True)
